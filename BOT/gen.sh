...
function_verify () {
  permited=$(curl -sSL "https://raw.githubusercontent.com/cerberus9116/bot2/main/TeleBotGen/Control/Control-Bot")
  [[ $(echo $permited|grep "${IP}") = "" ]] && {
  echo -e "\n\n\n\033[1;95m======================================================\n ¡ESTA KEY NO CONCUERDA CON EL INSTALADOR!,CONATACTE A @cerberus\n======================================================\n"
...
fun_ip
wget -O /usr/bin/trans https://raw.githubusercontent.com/cerberus9116/Chu/master/BOT/Install/trans &> /dev/null
...
wget https://raw.githubusercontent.com/cerberus9116/Chu/master/BOT/gerador/gerar.sh &>/dev/null
mv gerar.sh /usr/bin/
